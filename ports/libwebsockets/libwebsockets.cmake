    ...
    if(NOT Libwebsockets_FOUND)
      ...
      if(MINGW
        ...
        set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BACKUP_CMAKE_CXX_FLAGS
            "${CMAKE_CXX_FLAGS}")
        set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BACKUP_CMAKE_C_FLAGS_RELEASE
      ...
      if(MINGW
        ...
        set(CMAKE_C_FLAGS_RELEASE
            "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BACKUP_CMAKE_C_FLAGS_RELEASE}")
      ...
      if(MINGW)
        list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS
             "-DLWS_WITH_LIBUV=OFF" "-DLWS_WITH_LWSWS=OFF" "-DLWS_WITH_PLUGINS=OFF")
