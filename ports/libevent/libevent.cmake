...
if(NOT TARGET libevent::core)
  ...
  if(NOT TARGET libevent::core)
    ...
    # nghttp2 do not support libevent with mbedtls, so we disable it by default
    if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBEVENT_ENABLE_MBEDTLS
       OR NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_USE_MBEDTLS)
    ...
    elseif(ANDROID)
      message(WARNING "Android do not support pthread API but CMAKE_USE_PTHREADS_INIT=${CMAKE_USE_PTHREADS_INIT}")
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBEVENT_BUILD_OPTIONS "-DEVENT__DISABLE_THREAD_SUPPORT=ON")
    endif()
