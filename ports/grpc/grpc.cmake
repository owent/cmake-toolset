...
if(NOT TARGET gRPC::grpc++_alts
  ...
  if(NOT TARGET gRPC::grpc++_alts
    ...
    findconfigurepackage(
      ...
      BUILD_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/dependency-buildtree/grpc-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      PREFIX_DIRECTORY
