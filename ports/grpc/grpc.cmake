...
if(NOT TARGET gRPC::grpc++_alts
  ...
  if(NOT TARGET gRPC::grpc++_alts
    ...
    if(CMAKE_CXX_STANDARD)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_MAX_CXX_STANDARD 20)
      if(MSVC)
        set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_MAX_CXX_STANDARD 17)
      endif()
      if(CMAKE_CXX_STANDARD GREATER ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_MAX_CXX_STANDARD})
        set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_GRPC_BACKUP_CXX_STANDARD ${CMAKE_CXX_STANDARD})
        set(CMAKE_CXX_STANDARD ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_MAX_CXX_STANDARD})
      endif()
    elseif(MSVC)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_GRPC_BACKUP_CXX_STANDARD "UNSET")
    ...
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_GRPC_BACKUP_CXX_STANDARD)
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_GRPC_BACKUP_CXX_STANDARD STREQUAL "UNSET")
