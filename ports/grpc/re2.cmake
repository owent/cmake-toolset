...
if(NOT TARGET re2::re2)
  ...
  if(NOT TARGET re2::re2)
    ...
    findconfigurepackage(
      ...
      BUILD_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/dependency-buildtree/re2-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RE2_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      PREFIX_DIRECTORY
