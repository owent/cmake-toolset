...
if(NOT TARGET rapidjson
  ...
  set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_DEFAULT_BUILD_OPTIONS
      "-DRAPIDJSON_BUILD_DOC=OFF" "-DRAPIDJSON_BUILD_EXAMPLES=OFF" "-DRAPIDJSON_BUILD_TESTS=OFF"
      "-DRAPIDJSON_BUILD_THIRDPARTY_GTEST=OFF")
  project_third_party_port_declare(
    rapidjson
    VERSION
    "5ec44fb9206695e5293f610b0a46d21851d0c966" # 2024-03-08
    GIT_URL
    "https://github.com/Tencent/rapidjson.git"
    BUILD_OPTIONS
    ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_DEFAULT_BUILD_OPTIONS})

  project_third_party_try_patch_file(
    ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_PATCH_FILE "${CMAKE_CURRENT_LIST_DIR}" "rapidjson"
    "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_VERSION}")

  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_PATCH_FILE
     AND EXISTS "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_PATCH_FILE}")
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_BUILD_OPTIONS GIT_PATCH_FILES
         "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_PATCH_FILE}")
  endif()
