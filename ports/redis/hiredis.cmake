...
if(NOT TARGET hiredis::hiredis_ssl_static
  ...
  # if(NOT MSVC) list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_HIREDIS_DEFAULT_BUILD_OPTIONS
  ...
  project_third_party_port_declare(hiredis VERSION "v1.0.2" GIT_URL "https://github.com/redis/hiredis.git")
  set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_HIREDIS_PATCH_FILE
      "${CMAKE_CURRENT_LIST_DIR}/hiredis-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_HIREDIS_VERSION}.patch")
