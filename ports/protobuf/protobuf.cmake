...
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_BIN_PROTOC
  ...
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_ALLOW_LOCAL
     OR ENV{ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_ALLOW_LOCAL})
  ...
  if(NOT TARGET protobuf::libprotobuf AND NOT TARGET protobuf::libprotobuf-lite)
    include("${CMAKE_CURRENT_LIST_DIR}/protobuf-declare.cmake")
    ...
    project_build_tools_append_cmake_options_for_lib(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_FLAG_OPTIONS
                                                     DISABLE_C_STANDARD DISABLE_CXX_STANDARD)
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_VISIBILITY_HIDDEN)
      if(CMAKE_CXX_COMPILER_ID MATCHES "AppleClang|Clang|GNU")
    ...
    if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_FIND_LIB)
      include("${CMAKE_CURRENT_LIST_DIR}/protobuf-pull.cmake")
      ...
      if(EXISTS "${PROJECT_THIRD_PARTY_HOST_INSTALL_DIR}/include/absl/strings/escaping.h")
        list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_HOST_BUILD_FLAGS "-Dprotobuf_ABSL_PROVIDER=package")
      elseif(
        ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_STANDARD_VERSION VERSION_GREATER_EQUAL "3.22.0"
        AND absl_FOUND
        AND EXISTS
            "${PROJECT_THIRD_PARTY_PACKAGE_DIR}/abseil-cpp-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_ABSEIL_VERSION}/CMakeLists.txt"
      )
        list(
          APPEND
          ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_HOST_BUILD_FLAGS
          "-DABSL_ROOT_DIR=${PROJECT_THIRD_PARTY_PACKAGE_DIR}/abseil-cpp-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_ABSEIL_VERSION}"
        )
      endif()

      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_USE_CXX_STANDARD ${COMPILER_OPTION_RECOMMEND_CXX_STANDARD})
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_USE_C_STANDARD ${COMPILER_OPTION_RECOMMEND_C_STANDARD})
      if(CMAKE_CXX_STANDARD AND CMAKE_CXX_STANDARD LESS ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_USE_CXX_STANDARD)
        set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_USE_CXX_STANDARD ${CMAKE_CXX_STANDARD})
      endif()
      if(MSVC AND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_USE_CXX_STANDARD GREATER 17)
        # MSVC does not support C++20 to compile protobuf yet, some internal header can not compile in C++20, and they
      ...
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_HOST_BUILD_FLAGS
           "-DCMAKE_CXX_STANDARD=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_USE_CXX_STANDARD}")
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_BUILD_FLAGS
           "-DCMAKE_C_STANDARD=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_USE_C_STANDARD}")
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_HOST_BUILD_FLAGS
           "-DCMAKE_C_STANDARD=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PROTOBUF_USE_C_STANDARD}")
