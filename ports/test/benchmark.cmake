...
if(NOT TARGET benchmark::benchmark AND NOT TARGET benchmark::benchmark_main)
  ...
  if(NOT TARGET benchmark::benchmark AND NOT TARGET benchmark::benchmark_main)
    ...
    project_third_party_port_declare(benchmark VERSION "v1.7.1" GIT_URL "https://github.com/google/benchmark.git")
...
if(NOT TARGET benchmark::benchmark AND NOT TARGET benchmark::benchmark_main)
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CI_MODE)
    project_build_tools_print_configure_log("${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_BENCHMARK_BUILD_DIR}")
  endif()
