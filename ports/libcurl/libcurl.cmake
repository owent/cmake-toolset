...
macro(PROJECT_THIRD_PARTY_LIBCURL_IMPORT)
  if(CURL_FOUND)
    ...
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCH_LINK_NAMES)
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP2_LINK_NAME)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCH_LINK_NAMES
    ...
    if(TARGET Libngtcp2::libngtcp2_crypto_ossl)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCH_LINK_NAMES Libngtcp2::libngtcp2_crypto_ossl)
    endif()
    if(TARGET Libngtcp2::libngtcp2_crypto_quictls)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCH_LINK_NAMES Libngtcp2::libngtcp2_crypto_quictls)
    endif()
    if(TARGET Libngtcp2::libngtcp2_crypto_openssl)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCH_LINK_NAMES Libngtcp2::libngtcp2_crypto_openssl)
    endif()
    if(TARGET Libngtcp2::libngtcp2_crypto_boringssl)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCH_LINK_NAMES Libngtcp2::libngtcp2_crypto_boringssl)
    endif()
    ...
    if(TARGET CURL::libcurl
      ...
      foreach(PROJECT_THIRD_PARTY_LIBCURL_TARGET_NAME ${PROJECT_THIRD_PARTY_LIBCURL_TARGET_NAMES})
        ...
        message(
          "Libcurl: final patched link libraries -> ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCHED_INTERFACE_LINK_LIBRARIES}"
        )
      ...
      if(PkgConfig_FOUND)
        ...
        while(PROJECT_THIRD_PARTY_LIBCURL_DEP_PENDING_TARGETS)
          ...
          foreach(PROJECT_THIRD_PARTY_LIBCURL_DEP_LINK_NAME ${PROJECT_THIRD_PARTY_LIBCURL_DEP_INTERFACE_LINK_LIBRARIES})
            # Dependencies may be wrapped in generator expressions, e.g. $<LINK_ONLY:CURL::libssh2>
            if(PROJECT_THIRD_PARTY_LIBCURL_DEP_LINK_NAME MATCHES "^\\\$<LINK_ONLY:(.+)>$")
              set(PROJECT_THIRD_PARTY_LIBCURL_DEP_LINK_NAME "${CMAKE_MATCH_1}")
            endif()
      ...
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_STATIC_LINK_NAMES
         OR ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCH_LINK_NAMES)
        set_target_properties(
          CURL::libcurl
    ...
    unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_PATCH_LINK_NAMES)
...
if(NOT TARGET CURL::libcurl
  ...
  if(NOT CURL_FOUND)
    ...
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_DEFAULT_VERSION "8.21.0")
    ...
    if(OPENSSL_FOUND)
      ...
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_USE_BORINGSSL OR OPENSSL_VERSION VERSION_GREATER_EQUAL "3.0.0")
        list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_BUILD_OPTIONS
             ...
             "-DOpenSSL_ROOT=${PROJECT_THIRD_PARTY_INSTALL_DIR}" "-DOPENSSL_VERSION=${OPENSSL_VERSION}")
      elseif(
        OPENSSL_ROOT_DIR
    ...
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_VERSION VERSION_GREATER_EQUAL "7.71.0")
      ...
      elseif(
        ...
        AND (TARGET Libngtcp2::libngtcp2_crypto_ossl
             OR TARGET Libngtcp2::libngtcp2_crypto_openssl
             OR TARGET Libngtcp2::libngtcp2_crypto_quictls))
        list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_BUILD_OPTIONS "-DUSE_NGTCP2=ON")
      endif()
      # The compile flags for nghttp2, nghttp3, ngtcp2
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP3_LINK_NAME)
        project_third_party_merge_target_compile_options(
          ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP3_LINK_NAME}
          ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP3_CFLAGS)
        string(REPLACE ";" " " ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP3_CFLAGS
                       "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP3_CFLAGS}")
        if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP3_CFLAGS)
          list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_BUILD_OPTIONS
               "-DNGHTTP3_CFLAGS=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP3_CFLAGS}")
        endif()
      endif()
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGTCP2_LINK_NAME)
        project_third_party_merge_target_compile_options(
          ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGTCP2_LINK_NAME}
          ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGTCP2_CFLAGS)
        string(REPLACE ";" " " ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGTCP2_CFLAGS
                       "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGTCP2_CFLAGS}")
        if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGTCP2_CFLAGS)
          list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_BUILD_OPTIONS
               "-DNGTCP2_CFLAGS=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGTCP2_CFLAGS}")
        endif()
      endif()
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP2_LINK_NAME)
        ...
        project_third_party_merge_target_compile_options(
          ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP2_LINK_NAME}
          ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP2_CFLAGS)
        if(NOT HAVE_SIZEOF_SSIZE_T)
          if(SIZEOF_LONG EQUAL SIZEOF_SIZE_T)
            list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP2_CFLAGS "-Dssize_t=long"
                 "-D_SSIZE_T_DEFINED")
          elseif(NOT ssize_t AND SIZEOF___INT64 EQUAL SIZEOF_SIZE_T)
            list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP2_CFLAGS "-Dssize_t=__int64"
                 "-D_SSIZE_T_DEFINED")
          else()
            list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP2_CFLAGS "-DNGHTTP2_NO_SSIZE_T")
          endif()
        endif()
        string(REPLACE ";" " " ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP2_CFLAGS
                       "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP2_CFLAGS}")
        if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP2_CFLAGS)
          list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_BUILD_OPTIONS
               "-DNGHTTP2_CFLAGS=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_NGHTTP2_CFLAGS}")
        endif()
      endif()
