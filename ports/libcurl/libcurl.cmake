    ...
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_ZSTD_LINK_NAME)
      ...
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_ZSTD_LIBRARY
        ...
        list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_BUILD_FLAGS "-DCURL_ZSTD=ON"
             "-DZstd_INCLUDE_DIRS=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_ZSTD_INCLUDE_DIRS}"
             "-DZstd_LIBRARIES=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBCURL_WITH_ZSTD_LIBRARY}")
      endif()
    endif()
