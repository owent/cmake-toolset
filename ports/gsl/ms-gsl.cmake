...
if(NOT TARGET Microsoft.GSL::GSL)
  ...
  if(NOT TARGET Microsoft.GSL::GSL)
    project_third_party_port_declare(
      ...
      "-DGSL_TEST=OFF"
      "-DGSL_INSTALL=ON")
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_MICROSOFT_GSL_PATCH_FILE
        "${CMAKE_CURRENT_LIST_DIR}/Microsoft.GSL-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_MICROSOFT_GSL_VERSION}.patch")
