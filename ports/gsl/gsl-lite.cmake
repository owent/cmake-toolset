...
if(NOT TARGET gsl::gsl-lite)
  ...
  if(NOT TARGET gsl::gsl-lite)
    ...
    project_third_party_try_patch_file(
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GSL_LITE_PATCH_FILE "${CMAKE_CURRENT_LIST_DIR}" "gsl-lite"
    ...
    if(NOT TARGET gsl::gsl-lite)
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CI_MODE)
        project_build_tools_print_configure_log("${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GSL_LITE_BUILD_DIR}")
      endif()
