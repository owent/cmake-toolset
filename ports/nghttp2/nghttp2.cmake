...
if(NOT TARGET Libnghttp2::libnghttp2)
  ...
  if(NOT TARGET Libnghttp2::libnghttp2 AND NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBNGHTTP2_LINK_NAME)
    ...
    project_third_party_port_declare(
      Libnghttp2
      VERSION
      "v1.61.0" # curl support ngtcp2 v0.17.0 from 8.2 and v1.55.0 need ngtcp2 v0.17.0 or upper
      GIT_URL
    ...
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBNGHTTP2_RESET_SUBMODULE_URLS)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBNGHTTP2_SUB_MODULES GIT_RESET_SUBMODULE_URLS
           ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBNGHTTP2_RESET_SUBMODULE_URLS})
    endif()
    ...
    find_configure_package(
      ...
      ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBNGHTTP2_SUB_MODULES})
