...
macro(PROJECT_THIRD_PARTY_LIBUNWIND_IMPORT)
  ...
  elseif(Libunwind_FOUND)
    ...
    set_target_properties(Libunwind::libunwind PROPERTIES IMPORTED_LOCATION ${Libunwind_LIBRARIES})
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUNWIND_LINK_NAME Libunwind::libunwind)
  else()
...
if(NOT TARGET Libunwind::libunwind AND NOT Libunwind_FOUND)
  ...
  if(CMAKE_MAKE_PROGRAM MATCHES "make(.exe)?$")
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_LIBUNWIND_MAKE "${CMAKE_MAKE_PROGRAM}")
  else()
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_LIBUNWIND_MAKE "make")
  endif()
