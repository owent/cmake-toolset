...
if(NOT TARGET zstd::libzstd_shared
  ...
  if(NOT TARGET zstd::libzstd_shared
    ...
    findconfigurepackage(
      ...
      "-DLZ4_ROOT_DIR=${PROJECT_THIRD_PARTY_INSTALL_DIR}"
      "-DZLIB_ROOT=${PROJECT_THIRD_PARTY_INSTALL_DIR}"
      WORKING_DIRECTORY
      ...
      BUILD_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/dependency-buildtree/zstd-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_COMPRESSION_ZSTD_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      GIT_BRANCH
