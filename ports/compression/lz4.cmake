...
macro(PROJECT_THIRD_PARTY_LZ4_IMPORT)
  ...
  if(TARGET lz4::lz4cli OR TARGET lz4::lz4c)
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_COPY_EXECUTABLE_PATTERN
         "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_INSTALL_DIR}/bin/lz4*")
  endif()
endmacro()
...
if(NOT TARGET lz4::lz4_static
  ...
  if(NOT TARGET lz4::lz4_static
     ...
     AND NOT TARGET lz4::lz4cli
     AND NOT TARGET lz4::lz4c)
    set(PROJECT_THIRD_PARTY_LZ4_DEFAULT_VERSION "v1.9.3")
    ...
    findconfigurepackage(
      ...
      "-DLZ4_TOP_SOURCE_DIR=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PACKAGE_DIR}/lz4-${PROJECT_THIRD_PARTY_LZ4_DEFAULT_VERSION}"
      "-DLZ4_BUILD_CLI=ON"
      ...
      SRC_DIRECTORY_NAME
      "lz4-${PROJECT_THIRD_PARTY_LZ4_DEFAULT_VERSION}"
      PROJECT_DIRECTORY
      "${CMAKE_CURRENT_LIST_DIR}/lz4-build-script"
      BUILD_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/deps/lz4-${PROJECT_THIRD_PARTY_LZ4_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      GIT_BRANCH
      "${PROJECT_THIRD_PARTY_LZ4_DEFAULT_VERSION}"
      GIT_URL
