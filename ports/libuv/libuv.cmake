...
macro(PROJECT_THIRD_PARTY_LIBUV_IMPORT)
  ...
  elseif(Libuv_FOUND OR LIBUV_FOUND)
    ...
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_INC_DIR ${Libuv_INCLUDE_DIRS})
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LINK_NAME ${Libuv_LIBRARIES})

    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_INC_DIR)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PUBLIC_INCLUDE_DIRS
           ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_INC_DIR})
    endif()
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PUBLIC_LINK_NAMES
         ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LINK_NAME})
    if(WIN32)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PUBLIC_LINK_NAMES psapi iphlpapi userenv
           ws2_32)
    endif()
  else()
...
if(NOT TARGET uv_a
  ...
  if(NOT TARGET uv_a
    ...
    set(Libuv_ROOT ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_INSTALL_DIR})
