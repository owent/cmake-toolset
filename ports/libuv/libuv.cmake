...
macro(PROJECT_THIRD_PARTY_LIBUV_IMPORT)
  ...
  if(TARGET ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_PREFER_TARGET})
    ...
    project_build_tools_get_imported_property(
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_PREFER_TARGET}
      IMPORTED_IMPLIB)
    project_build_tools_get_imported_location(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LOCATION
                                              ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_PREFER_TARGET})
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LIBRARIES "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB}")
    else()
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LIBRARIES
          "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LOCATION}")
    endif()
  elseif(TARGET libuv::${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_PREFER_TARGET})
    ...
    project_build_tools_get_imported_property(
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB
      libuv::${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_PREFER_TARGET} IMPORTED_IMPLIB)
    project_build_tools_get_imported_location(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LOCATION
                                              libuv::${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_PREFER_TARGET})
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LIBRARIES "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB}")
  ...
  elseif(TARGET ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_FALLBACK_TARGET})
    ...
    project_build_tools_get_imported_property(
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_FALLBACK_TARGET}
      IMPORTED_IMPLIB)
    project_build_tools_get_imported_location(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LOCATION
                                              ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_FALLBACK_TARGET})
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB)
  ...
  elseif(TARGET libuv::${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_FALLBACK_TARGET})
    ...
    project_build_tools_get_imported_property(
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB
      libuv::${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_FALLBACK_TARGET} IMPORTED_IMPLIB)
    project_build_tools_get_imported_location(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LOCATION
                                              libuv::${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_FALLBACK_TARGET})
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LIBRARIES "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB}")
  ...
  elseif(TARGET libuv)
    ...
    project_build_tools_get_imported_property(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB libuv IMPORTED_IMPLIB)
    project_build_tools_get_imported_location(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LOCATION libuv)
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LIBRARIES "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB}")
    else()
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LIBRARIES
  ...
  elseif(TARGET libuv::libuv)
    ...
    project_build_tools_get_imported_property(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB libuv::libuv
                                              IMPORTED_IMPLIB)
    project_build_tools_get_imported_location(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LOCATION libuv::libuv)
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LIBRARIES "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_IMPLIB}")
    else()
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_LIBRARIES
...
if(NOT TARGET uv_a
  ...
  if(NOT TARGET uv_a
    ...
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBUV_DEFAULT_VERSION "v1.50.0")
