...
macro(PROJECT_THIRD_PARTY_NGHTTP3_IMPORT)
  if(TARGET nghttp3::nghttp3 OR TARGET nghttp3::nghttp3_static)
    if(TARGET nghttp3::nghttp3)
      ...
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP3_LINK_NAME nghttp3::nghttp3)
    elseif(TARGET nghttp3::nghttp3_static)
      message(STATUS "Dependency(${PROJECT_NAME}): nghttp3 using target nghttp3::nghttp3_static")
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP3_LINK_NAME nghttp3::nghttp3_static)
    endif()
...
if(NOT TARGET nghttp3::nghttp3 AND NOT TARGET nghttp3::nghttp3_static)
  ...
  if(NOT TARGET nghttp3::nghttp3
     AND NOT TARGET nghttp3::nghttp3_static
     AND NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP3_LINK_NAME)
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_NGHTTP3_DEFAULT_BUILD_OPTIONS
