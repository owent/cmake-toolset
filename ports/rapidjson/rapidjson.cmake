...
macro(PROJECT_THIRD_PARTY_RAPIDJSON_IMPORT)
  if(TARGET rapidjson)
    ...
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PUBLIC_LINK_NAMES rapidjson)
  elseif(Rapidjson_INCLUDE_DIRS OR RapidJSON_INCLUDE_DIRS)
    ...
    message(
      STATUS
        "Dependency(${PROJECT_NAME}): rapidjson using include directory: ${RapidJSON_INCLUDE_DIRS}")
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PUBLIC_INCLUDE_DIRS ${RapidJSON_INCLUDE_DIRS})
  endif()
endmacro()
...
if(NOT TARGET rapidjson
  ...
  findconfigurepackage(
    ...
    BUILD_DIRECTORY
    "${CMAKE_CURRENT_BINARY_DIR}/dependency-buildtree/rapidjson-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_RAPIDJSON_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
    PREFIX_DIRECTORY
