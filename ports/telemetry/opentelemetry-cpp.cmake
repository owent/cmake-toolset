...
if(NOT TARGET opentelemetry-cpp::api AND NOT TARGET opentelemetry-cpp::sdk)
  ...
  if(NOT TARGET opentelemetry-cpp::api AND NOT TARGET opentelemetry-cpp::sdk)
    ...
    project_third_party_port_declare(opentelemetry_cpp VERSION "v1.19.0" GIT_URL
    ...
    if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENTELEMETRY_CPP_BUILD_OPTIONS)
      ...
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENTELEMETRY_CPP_STANDARD_VERSION VERSION_GREATER "1.15.0"
        ...
        if(COMPILER_OPTION_RECOMMEND_CXX_STANDARD GREATER_EQUAL 20)
          set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENTELEMETRY_CPP_WITH_STL "CXX20")
        elseif(COMPILER_OPTION_RECOMMEND_CXX_STANDARD GREATER_EQUAL 17)
          set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENTELEMETRY_CPP_WITH_STL "CXX17")
        elseif(COMPILER_OPTION_RECOMMEND_CXX_STANDARD GREATER_EQUAL 14)
