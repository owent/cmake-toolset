...
if(NOT TARGET c-ares::cares
  ...
  if(NOT TARGET c-ares::cares
    ...
    if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_VERSION)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_VERSION "1.17.1")
    endif()

    if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_GIT_URL)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_GIT_URL
          "https://github.com/c-ares/c-ares.git")
    endif()

    if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_BUILD_OPTIONS)
    ...
    project_third_party_append_find_root_args(
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_BUILD_OPTIONS)
    project_third_party_append_build_shared_lib_var(
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_BUILD_OPTIONS CARES_SHARED BUILD_SHARED_LIBS)
    project_third_party_append_build_static_lib_var(
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_BUILD_OPTIONS CARES_STATIC)

    string(REPLACE "." "_" ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CARES_DEFAULT_VERSION
                   "cares-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_VERSION}")
    ...
    findconfigurepackage(
      ...
      BUILD_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/dependency-buildtree/c-ares-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      PREFIX_DIRECTORY
      "${PROJECT_THIRD_PARTY_INSTALL_DIR}"
      SRC_DIRECTORY_NAME
      "c-ares-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_VERSION}"
      GIT_BRANCH
      "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CARES_DEFAULT_VERSION}"
      GIT_URL
      "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_GRPC_CARES_GIT_URL}")
