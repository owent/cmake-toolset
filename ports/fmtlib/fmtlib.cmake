...
int main() {
  ...
  return 0;
    ...
    if(NOT TARGET fmt::fmt-header-only
      ...
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_FMTLIB_DEFAULT_VERSION "11.2.0")
      ...
      project_third_party_try_patch_file(
        ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_FMTLIB_PATCH_FILE "${CMAKE_CURRENT_LIST_DIR}" "fmtlib"
        "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_FMTLIB_VERSION}")

      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_FMTLIB_PATCH_FILE
         AND EXISTS "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_FMTLIB_PATCH_FILE}")
      ...
      if(fmt_FOUND)
        ...
        if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CI_MODE)
          project_build_tools_print_configure_log("${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_FMTLIB_BUILD_DIR}")
        endif()
