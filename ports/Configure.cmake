...
if(CMAKE_CXX_FLAGS MATCHES "fsanitize=([^ \t\r\n]+)")
  set(PROJECT_COMPILER_OPTIONS_TARGET_USE_SANITIZER "${CMAKE_MATCH_1}")
elseif(CMAKE_C_FLAGS MATCHES "fsanitize=([^ \t\r\n]+)")
  set(PROJECT_COMPILER_OPTIONS_TARGET_USE_SANITIZER "${CMAKE_MATCH_1}")
endif()

if(COMPILER_OPTION_INHERIT_CMAKE_CXX_FLAGS MATCHES "fsanitize=([^ \t\r\n]+)")
  set(PROJECT_COMPILER_OPTIONS_HOST_USE_SANITIZER "${CMAKE_MATCH_1}")
elseif(COMPILER_OPTION_INHERIT_CMAKE_C_FLAGS MATCHES "fsanitize=([^ \t\r\n]+)")
  set(PROJECT_COMPILER_OPTIONS_HOST_USE_SANITIZER "${CMAKE_MATCH_1}")
endif()
