...
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS AND ENV{ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS})
  set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS "$ENV{ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS}")
endif()
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS)
  cmake_host_system_information(RESULT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS
                                QUERY NUMBER_OF_PHYSICAL_CORES)
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS)
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS GREATER 2)
      math(EXPR ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS
           "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS} - 1")
    endif()
  else()
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS 2)
  endif()
  set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS
      "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS}"
      CACHE STRING "Parallel build jobs")
endif()
...
if(CMAKE_CXX_COMPILER_VERSION MATCHES "([0-9]+)")
  set(PROJECT_THIRD_PARTY_INSTALL_DEFAULT_SUFFIX "-${CMAKE_MATCH_1}${PROJECT_THIRD_PARTY_INSTALL_DEFAULT_SUFFIX}")
  set(PROJECT_THIRD_PARTY_HOST_INSTALL_DEFAULT_SUFFIX
      "-${CMAKE_MATCH_1}${PROJECT_THIRD_PARTY_HOST_INSTALL_DEFAULT_SUFFIX}")
elseif(CMAKE_C_COMPILER_VERSION MATCHES "([0-9]+)")
  set(PROJECT_THIRD_PARTY_INSTALL_DEFAULT_SUFFIX "-${CMAKE_MATCH_1}${PROJECT_THIRD_PARTY_INSTALL_DEFAULT_SUFFIX}")
  set(PROJECT_THIRD_PARTY_HOST_INSTALL_DEFAULT_SUFFIX
      "-${CMAKE_MATCH_1}${PROJECT_THIRD_PARTY_HOST_INSTALL_DEFAULT_SUFFIX}")
endif()
...
if(NOT PROJECT_FIND_CONFIGURE_PACKAGE_PARALLEL_BUILD)
  ...
  elseif(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS)
    set(PROJECT_FIND_CONFIGURE_PACKAGE_PARALLEL_BUILD ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_PARALLEL_JOBS})
  endif()
endif()
...
function(project_third_party_mutable_package_targets PORT_NAME)
  ...
  set(__project_third_party_mutable_package_targets_SOURCE_DIR "${CMAKE_SOURCE_DIR}/.cmake-toolset/${PORT_NAME}")
  set(__project_third_party_mutable_package_targets_BINARY_DIR "${CMAKE_BINARY_DIR}/.cmake-toolset/${PORT_NAME}")

  file(MAKE_DIRECTORY "${__project_third_party_mutable_package_targets_SOURCE_DIR}"
       "${__project_third_party_mutable_package_targets_BINARY_DIR}")
  file(
    WRITE "${__project_third_party_mutable_package_targets_SOURCE_DIR}/CMakeLists.txt"
    "
...
")
  add_subdirectory("${__project_third_party_mutable_package_targets_SOURCE_DIR}"
                   "${__project_third_party_mutable_package_targets_BINARY_DIR}")
endfunction()
