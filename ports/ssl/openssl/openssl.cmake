...
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_LINK_NAME)
  if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_VERSION)
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_VERSION "3.0.2")
    # OpenSSL 3.0.0 has some problems with nmake and MSVC when installing
    if(CMAKE_VERSION VERSION_LESS "3.18.0" OR MSVC)
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_VERSION "1.1.1n")
    endif()
  endif()
  ...
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_VERSION VERSION_GREATER_EQUAL "3.0.0")
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_GITHUB_TAG
  ...
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_BUILD_OPTIONS)
    ...
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_BUILD_OPTIONS
        ...
        "no-weak-ssl-ciphers")
    if(NOT MSVC)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_BUILD_OPTIONS "pic")
    endif()
    ...
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_APPEND_DEFAULT_BUILD_OPTIONS)
      list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_BUILD_OPTIONS
           ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_APPEND_DEFAULT_BUILD_OPTIONS})
    endif()
  endif()
    ...
    if(NOT MSVC)
      ...
      if(ANDROID)
        ...
        if(ANDROID_PLATFORM_LEVEL)
          ...
          string(REPLACE "android-" "" ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_ANDROID_PLATFORM_LEVEL
                         ${ANDROID_PLATFORM})
          list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_BUILD_OPTIONS
               "-D__ANDROID_API__=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_ANDROID_PLATFORM_LEVEL}")
        endif()
