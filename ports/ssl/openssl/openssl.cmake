...
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_LINK_NAME)
  ...
  if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_VERSION)
    # OpenSSL 3.2 support quic but do not support HTTP/3
  ...
  if(OPENSSL_FOUND OR OpenSSL_FOUND)
    file(REAL_PATH "${OPENSSL_ROOT_DIR}/include" ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_EXPECT_PATH)
    file(REAL_PATH "${OPENSSL_INCLUDE_DIR}" ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_REAL_PATH)
    file(TO_CMAKE_PATH "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_EXPECT_PATH}"
         ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_EXPECT_PATH)
    file(TO_CMAKE_PATH "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_REAL_PATH}"
         ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_REAL_PATH)

    if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_EXPECT_PATH STREQUAL
       ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_REAL_PATH)
      unset(OPENSSL_ROOT_DIR)
    endif()

    unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_EXPECT_PATH)
    unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_TEST_REAL_PATH)
  else()
    find_library(
