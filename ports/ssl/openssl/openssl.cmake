    ...
    if(NOT MSVC)
      ...
      if(NOT ANDROID)
        if(CMAKE_OSX_SYSROOT)
          list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_CFLAGS "-isysroot"
               "${CMAKE_OSX_SYSROOT}")
        ...
        if(CMAKE_OSX_DEPLOYMENT_TARGET)
          list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_CFLAGS
      ...
      if(CMAKE_C_FLAGS
         ...
         OR ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_CFLAGS)
        list(
          APPEND
          ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_BUILD_OPTIONS
          "CFLAGS=${CMAKE_C_FLAGS} ${CMAKE_C_FLAGS_RELEASE} ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_CFLAGS}"
        )
      endif()
      ...
      if(CMAKE_CXX_FLAGS
        ...
        list(
          APPEND
          ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_BUILD_OPTIONS
          "CXXFLAGS=${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_RELEASE} ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_OPENSSL_CFLAGS}"
        )
      endif()
      ...
      elseif(CMAKE_OSX_ARCHITECTURES)
        if(CMAKE_OSX_ARCHITECTURES MATCHES "armv7s?")
      ...
      execute_process(
        COMMAND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_OPENSSL_BUILD_DIR}/run-config.sh"
