  ...
  if(OPENSSL_FOUND OR OpenSSL_FOUND)
    ...
    if(TARGET OpenSSL::SSL OR TARGET OpenSSL::Crypto)
      ...
      if(OPENSSL_LIBRARIES)
        ...
        set_target_properties(OpenSSL::Crypto PROPERTIES INTERFACE_LINK_LIBRARIES ${OPENSSL_CRYPTO_LIBRARIES})
        add_library(OpenSSL::SSL UNKNOWN IMPORTED)
        set_target_properties(OpenSSL::SSL PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${OPENSSL_INCLUDE_DIR})
        set_target_properties(OpenSSL::SSL PROPERTIES INTERFACE_LINK_LIBRARIES ${OPENSSL_SSL_LIBRARIES} OpenSSL::Crypto)
