...
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_LINK_NAME)
  set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_DEFAULT_VERSION "3.3.1")
  ...
  if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_INCLUDE_MODULE_DIR)
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_INCLUDE_MODULE_DIR TRUE)
    list(
      APPEND
      CMAKE_MODULE_PATH
      "${PROJECT_THIRD_PARTY_PACKAGE_DIR}/libressl-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_DEFAULT_VERSION}"
    )
  endif()

  if(NOT LIBRESSL_FOUND)
    set(OPENSSL_ROOT_DIR ${PROJECT_THIRD_PARTY_INSTALL_DIR})
    set(LIBRESSL_ROOT_DIR ${PROJECT_THIRD_PARTY_INSTALL_DIR})
    set(LibreSSL_ROOT ${PROJECT_THIRD_PARTY_INSTALL_DIR})
  ...
  if(NOT LIBRESSL_FOUND)
    ...
    if(EXISTS
       "${PROJECT_THIRD_PARTY_PACKAGE_DIR}/libressl-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_DEFAULT_VERSION}/CMakeCache.txt"
    )
      execute_process(
        COMMAND
    ...
    if(NOT
      ...
      if(NOT
         EXISTS
         "${PROJECT_THIRD_PARTY_PACKAGE_DIR}/libressl-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_DEFAULT_VERSION}.tar.gz"
      )
        findconfigurepackagedownloadfile(
          "https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_DEFAULT_VERSION}.tar.gz"
          "${PROJECT_THIRD_PARTY_PACKAGE_DIR}/libressl-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_DEFAULT_VERSION}.tar.gz"
        )
      endif()
    ...
    unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_FLAGS)
    list(
      APPEND
      ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_FLAGS
      ${CMAKE_COMMAND}
      "${PROJECT_THIRD_PARTY_PACKAGE_DIR}/libressl-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_DEFAULT_VERSION}"
    ...
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR
        "${CMAKE_CURRENT_BINARY_DIR}/deps/libressl-${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_DEFAULT_VERSION}/build_jobs_dir_${PROJECT_PREBUILT_PLATFORM_NAME}"
    )
    ...
    if(CMAKE_HOST_UNIX
       OR MSYS
       OR CYGWIN)
      file(WRITE "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.sh"
           "#!/bin/bash${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}")
      file(WRITE "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.sh"
           "#!/bin/bash${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}")
      file(
        APPEND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.sh"
        "export PATH=\"${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}:\$PATH\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
      )
      file(
        APPEND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.sh"
        "export PATH=\"${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}:\$PATH\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
      )
      project_make_executable(
        "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.sh")
      project_make_executable(
        "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.sh")
      ...
      # build & install
      message(
        STATUS "@${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR} Run: ./run-cmake.sh")
      message(
        STATUS
          "@${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR} Run: ./run-build-release.sh"
      )
      execute_process(
        COMMAND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.sh"
        WORKING_DIRECTORY ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR})

      execute_process(
        COMMAND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.sh"
        WORKING_DIRECTORY ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR})

    else()
      file(WRITE "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.bat"
           "@echo off${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}")
      file(WRITE "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-debug.bat"
           "@echo off${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}")
      file(WRITE "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.bat"
           "@echo off${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}")
      file(APPEND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.bat"
           "set PATH=${ATFRAME_THIRD_PARTY_ENV_PATH};%PATH%${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}")
      file(APPEND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-debug.bat"
           "set PATH=${ATFRAME_THIRD_PARTY_ENV_PATH};%PATH%${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}")
      file(APPEND
           "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.bat"
           "set PATH=${ATFRAME_THIRD_PARTY_ENV_PATH};%PATH%${PROJECT_THIRD_PARTY_BUILDTOOLS_EOL}")
      project_make_executable(
        "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.bat")
      project_make_executable(
        "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-debug.bat")
      project_make_executable(
        "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.bat")
      project_expand_list_for_command_line_to_file(
        "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.bat"
      ...
      message(
        STATUS
          "@${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR} Run: ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.bat"
      )
      message(
        STATUS
          "@${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR} Run: ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-release.bat"
      )
      execute_process(
        COMMAND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-cmake.bat"
        WORKING_DIRECTORY ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR})
      # install debug target
      if(MSVC)
        message(
          STATUS
            "@${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR} Run: ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-debug.bat"
        )
        execute_process(
          COMMAND "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR}/run-build-debug.bat"
          WORKING_DIRECTORY ${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBRESSL_BUILD_DIR})
      endif()
    ...
    if(WIN32)
      ...
      file(GLOB LIBRESSL_PATCH_WIN32_FILE_NAMES
           "${PROJECT_THIRD_PARTY_INSTALL_DIR}/lib/crypto-*.lib")
      ...
      file(GLOB LIBRESSL_PATCH_WIN32_FILE_NAMES
           "${PROJECT_THIRD_PARTY_INSTALL_DIR}/bin/crypto-*.dll")
      if(LIBRESSL_PATCH_WIN32_FILE_NAMES)
        list(GET LIBRESSL_PATCH_WIN32_FILE_NAMES 0 LIBRESSL_PATCH_WIN32_FILE_NAME)
        file(RENAME ${LIBRESSL_PATCH_WIN32_FILE_NAME}
             "${PROJECT_THIRD_PARTY_INSTALL_DIR}/bin/crypto.dll")
      ...
      if(LIBRESSL_PATCH_WIN32_FILE_NAMES)
        list(GET LIBRESSL_PATCH_WIN32_FILE_NAMES 0 LIBRESSL_PATCH_WIN32_FILE_NAME)
        file(RENAME ${LIBRESSL_PATCH_WIN32_FILE_NAME}
             "${PROJECT_THIRD_PARTY_INSTALL_DIR}/lib/ssl.lib")
      endif()
      unset(LIBRESSL_PATCH_WIN32_FILE_NAMES)
      ...
      if(LIBRESSL_PATCH_WIN32_FILE_NAMES)
        list(GET LIBRESSL_PATCH_WIN32_FILE_NAMES 0 LIBRESSL_PATCH_WIN32_FILE_NAME)
        file(RENAME ${LIBRESSL_PATCH_WIN32_FILE_NAME}
             "${PROJECT_THIRD_PARTY_INSTALL_DIR}/bin/ssl.dll")
      endif()
      unset(LIBRESSL_PATCH_WIN32_FILE_NAMES)
      ...
      if(LIBRESSL_PATCH_WIN32_FILE_NAMES)
        list(GET LIBRESSL_PATCH_WIN32_FILE_NAMES 0 LIBRESSL_PATCH_WIN32_FILE_NAME)
        file(RENAME ${LIBRESSL_PATCH_WIN32_FILE_NAME}
             "${PROJECT_THIRD_PARTY_INSTALL_DIR}/lib/tls.lib")
      endif()
      unset(LIBRESSL_PATCH_WIN32_FILE_NAMES)
      ...
      if(LIBRESSL_PATCH_WIN32_FILE_NAMES)
        list(GET LIBRESSL_PATCH_WIN32_FILE_NAMES 0 LIBRESSL_PATCH_WIN32_FILE_NAME)
        file(RENAME ${LIBRESSL_PATCH_WIN32_FILE_NAME}
             "${PROJECT_THIRD_PARTY_INSTALL_DIR}/bin/tls.dll")
      endif()
      unset(LIBRESSL_PATCH_WIN32_FILE_NAMES)
