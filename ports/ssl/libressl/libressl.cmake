...
if(NOT TARGET LibreSSL::Crypto)
  if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_LIBRESSL_VERSION)
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_LIBRESSL_VERSION "3.3.3")
  endif()
  ...
  if(NOT TARGET LibreSSL::Crypto)
    ...
    if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_LIBRESSL_BUILD_FLAGS)
      ...
      project_third_party_append_build_shared_lib_var(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_LIBRESSL_BUILD_FLAGS
                                                      BUILD_SHARED_LIBS)
    else()
      set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_LIBRESSL_BUILD_FLAGS
          ${CMAKE_COMMAND}
  ...
  if(LIBRESSL_FOUND)
    echowithcolor(COLOR GREEN "-- Dependency(${PROJECT_NAME}): Libressl found.(${LIBRESSL_VERSION})")
  else()
