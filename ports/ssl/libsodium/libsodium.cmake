  ...
  if(MSVC AND NOT MINGW)
    ...
    if(EXISTS "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_SOURCE_DIR}")
      ...
      if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_BUILD_RESULT EQUAL 0)
        ...
        # builds/msvc/properties/Output.props). Select only the active linkage directory to avoid mixing static and
        # dynamic libs with the same basename into one install path.
        if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_MSBUILD_LINKAGE STREQUAL "DLL")
          set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_LINKAGE_DIR "dynamic")
        else()
          set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_LINKAGE_DIR "static")
        endif()

        set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_SEARCH_ROOT
            "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_SOURCE_DIR}/bin/${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_MSBUILD_PLATFORM}/Release"
        )
        file(
          GLOB_RECURSE
          ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_LIBS
          "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_SEARCH_ROOT}/*/${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_LINKAGE_DIR}/*.lib"
        )
        if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_MSBUILD_LINKAGE STREQUAL "DLL")
          file(
            GLOB_RECURSE
            ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_DLLS
            "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_SEARCH_ROOT}/*/${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_LINKAGE_DIR}/*.dll"
          )
        else()
          unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_DLLS)
        endif()

        file(REMOVE "${PROJECT_THIRD_PARTY_INSTALL_DIR}/lib/libsodium.lib"
             "${PROJECT_THIRD_PARTY_INSTALL_DIR}/lib/sodium.lib" "${PROJECT_THIRD_PARTY_INSTALL_DIR}/bin/libsodium.dll"
        ...
        unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_SEARCH_ROOT)
        unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBSODIUM_INSTALL_LINKAGE_DIR)
