...
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_LINK_NAME)
  ...
  set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_DEFAULT_BUILD_OPTIONS
      "-DCMAKE_POSITION_INDEPENDENT_CODE=ON" "-DGO_EXECUTABLE=${GO_EXECUTABLE}" "-DPERL_EXECUTABLE=${PERL_EXECUTABLE}")

  # Boringssl depends C++ runtime, which will lead to link error when using as openssl compact library if we use static
  # library
  if(WIN32)
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_DEFAULT_BUILD_OPTIONS "-DBUILD_SHARED_LIBS=OFF")
  else()
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_DEFAULT_BUILD_OPTIONS "-DBUILD_SHARED_LIBS=ON")
  endif()
  if(CMAKE_CROSSCOMPILING)
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_DEFAULT_BUILD_OPTIONS "-DOPENSSL_NO_ASM=ON")
  endif()
  # Just follow the settings of gRPC port
  if(MSVC AND MSVC_VERSION LESS 1945)
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_DEFAULT_VERSION
        "dec0d8f681348af8bb675e07bd89989665fca8bc")
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang" AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS "15")
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_DEFAULT_VERSION
        "b8b3e6e11166719a8ebfa43c0cde9ad7d57a84f6")
  else()
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_DEFAULT_VERSION
        "2b44a3701a4788e1ef866ddc7f143060a3d196c9")
  endif()
  ...
  # Clone the repository first to detect the source tree layout. BoringSSL flattened its directory structure (the cmake
  # project moved from src/ to the repository root), while older pinned commits still use the src/ subdirectory.
  set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_GIT_CLONE_ARGS
      URL "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_GIT_URL}" REPO_DIRECTORY
      "${PROJECT_THIRD_PARTY_PACKAGE_DIR}/${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_SRC_DIRECTORY_NAME}"
      BRANCH "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_VERSION}")
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_PATCH_FILE
     AND EXISTS "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_PATCH_FILE}")
    list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_GIT_CLONE_ARGS PATCH_FILES
         "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_PATCH_FILE}")
  endif()
  project_git_clone_repository(${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_GIT_CLONE_ARGS})
  unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_GIT_CLONE_ARGS)

  if(EXISTS
     "${PROJECT_THIRD_PARTY_PACKAGE_DIR}/${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_SRC_DIRECTORY_NAME}/src/CMakeLists.txt"
  )
    set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_PROJECT_DIRECTORY
  ...
  find_configure_package(
    ...
    PROJECT_DIRECTORY
    "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_PROJECT_DIRECTORY}"
    GIT_BRANCH
    "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_VERSION}"
    GIT_URL
  ...
  unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_PATCH_LIBUNWIND)
  unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_BORINGSSL_PROJECT_DIRECTORY)
