...
macro(PROJECT_THIRD_PARTY_BORINGSSL_PREPEND_STANDARD_LIBRARIES VAR_NAME OTHER_FLAGS)
  if(${VAR_NAME})
...
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_LINK_NAME)
  ...
  unset(ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_CXX_STANDARD_LIBRARIES)
  unset(ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_C_STANDARD_LIBRARIES)
  if(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND NOT CMAKE_CROSSCOMPILING)
    ...
    if(PkgConfig_FOUND)
      ...
      if(LIBUNWIND_FOUND)
        message(STATUS "libunwind-generic for boringssl found.
        VERSION: ${LIBUNWIND_VERSION}
        PREFIX: ${LIBUNWIND_PREFIX}
        CFLAGS: ${LIBUNWIND_CFLAGS}
        INCLUDE_DIRS: ${LIBUNWIND_INCLUDE_DIRS}
        LDFLAGS: ${LIBUNWIND_LDFLAGS}")
        set(ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_CXX_STANDARD_LIBRARIES "${CMAKE_CXX_STANDARD_LIBRARIES}")
        set(ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_C_STANDARD_LIBRARIES "${CMAKE_C_STANDARD_LIBRARIES}")
        if(TARGET ZLIB::ZLIB)
          PROJECT_THIRD_PARTY_BORINGSSL_PREPEND_STANDARD_LIBRARIES(CMAKE_CXX_STANDARD_LIBRARIES "-lz")
          PROJECT_THIRD_PARTY_BORINGSSL_PREPEND_STANDARD_LIBRARIES(CMAKE_C_STANDARD_LIBRARIES "-lz")
        endif()
        PROJECT_THIRD_PARTY_BORINGSSL_PREPEND_STANDARD_LIBRARIES(CMAKE_CXX_STANDARD_LIBRARIES "${LIBUNWIND_LDFLAGS}")
        PROJECT_THIRD_PARTY_BORINGSSL_PREPEND_STANDARD_LIBRARIES(CMAKE_C_STANDARD_LIBRARIES "${LIBUNWIND_LDFLAGS}")
      endif()
    endif()
  endif()
  ...
  if(DEFINED ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_CXX_STANDARD_LIBRARIES)
    set(CMAKE_CXX_STANDARD_LIBRARIES "${ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_CXX_STANDARD_LIBRARIES}")
    unset(ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_CXX_STANDARD_LIBRARIES)
  endif()
  if(DEFINED ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_C_STANDARD_LIBRARIES)
    set(CMAKE_C_STANDARD_LIBRARIES "${ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_C_STANDARD_LIBRARIES}")
    unset(ATFRAMEWORK_CMAKE_TOOLSET_BACKUP_CMAKE_C_STANDARD_LIBRARIES)
  endif()
