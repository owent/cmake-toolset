...
**/")
    ...
    if(TARGET OpenSSL::SSL OR TARGET OpenSSL::Crypto)
      ...
      if(TARGET OpenSSL::Crypto)
        ...
        get_property(OPENSSL_CRYPTO_INTERFACE_LINK_LIBRARIES OpenSSL::Crypto PROPERTY INTERFACE_LINK_LIBRARIES)
      ...
      if(TARGET OpenSSL::SSL)
        ...
        get_property(OPENSSL_SSL_INTERFACE_LINK_LIBRARIES OpenSSL::SSL PROPERTY INTERFACE_LINK_LIBRARIES)
