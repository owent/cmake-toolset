...
if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_LINK_NAME)
  ...
  unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_BORINGSSL_PATCH_LIBUNWIND)
  if(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND NOT CMAKE_CROSSCOMPILING)
    ...
    if(PkgConfig_FOUND)
      ...
      if(LIBUNWIND_FOUND)
        ...
        string(REPLACE ";" " " ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_BORINGSSL_PATCH_LIBUNWIND " ${LIBUNWIND_LDFLAGS}")
        if(TARGET ZLIB::ZLIB)
          set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_BORINGSSL_PATCH_LIBUNWIND
              "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_BORINGSSL_PATCH_LIBUNWIND} -lz")
        endif()
      endif()
    endif()
  endif()
  ...
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_BORINGSSL_PATCH_LIBUNWIND)
    set(PROJECT_BUILD_TOOLS_CMAKE_PATCH_INHERIT_CMAKE_CXX_STANDARD_LIBRARIES
        "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_BORINGSSL_PATCH_LIBUNWIND}")
