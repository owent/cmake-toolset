    ...
    if(PkgConfig_FOUND)
      ...
      if(LIBUNWIND_FOUND)
        ...
        if (CMAKE_CXX_STANDARD_LIBRARIES)
          set(CMAKE_CXX_STANDARD_LIBRARIES "${CMAKE_CXX_STANDARD_LIBRARIES} ${LIBUNWIND_LDFLAGS}"
        else()
          set(CMAKE_CXX_STANDARD_LIBRARIES "${LIBUNWIND_LDFLAGS}"
        endif()
        if (CMAKE_C_STANDARD_LIBRARIES)
          set(CMAKE_C_STANDARD_LIBRARIES "${CMAKE_C_STANDARD_LIBRARIES} ${LIBUNWIND_LDFLAGS}"
        else()
          set(CMAKE_C_STANDARD_LIBRARIES "${LIBUNWIND_LDFLAGS}"
        endif()
      endif()
    endif()
  endif()
