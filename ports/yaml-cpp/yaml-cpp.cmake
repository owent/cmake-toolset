...
if(NOT TARGET yaml-cpp::yaml-cpp
  ...
  if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_YAML_CPP_VERSION VERSION_GREATER_EQUAL "0.8.0"
     AND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_YAML_CPP_VERSION VERSION_LESS "0.9.0")
  ...
  find_configure_package(
    ...
    BUILD_DIRECTORY
    "${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_YAML_CPP_BUILD_DIR}"
    PREFIX_DIRECTORY
  ...
  if(NOT TARGET yaml-cpp::yaml-cpp
    ...
    if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CI_MODE)
      project_build_tools_print_configure_log("${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_YAML_CPP_BUILD_DIR}")
    endif()
    echowithcolor(
      COLOR
      RED
