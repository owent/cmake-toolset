    ...
    if(NOT Libwebsockets_FOUND)
      ...
      if(OPENSSL_FOUND AND NOT LIBRESSL_FOUND)
        ...
        if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPTO_USE_BORINGSSL OR OPENSSL_VERSION VERSION_GREATER_EQUAL "3.0.0")
          ...
          if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_DEPEND_NAME)
            list_append_unescape(
              ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS
              "-DLWS_OPENSSL_LIBRARIES=${OPENSSL_SSL_LIBRARY};${OPENSSL_CRYPTO_LIBRARY};${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_DEPEND_NAME}"
            )
          else()
            list_append_unescape(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS
        ...
        if(MSVC OR ANDROID)
          ...
          if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_DEPEND_NAME)
            list_append_unescape(
              ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS
              "-DLWS_OPENSSL_LIBRARIES=${OPENSSL_LIBRARIES};${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_CRYPT_DEPEND_NAME}")
          else()
            list_append_unescape(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS
