  ...
  if(NOT Libwebsockets_FOUND
    ...
    if(NOT Libwebsockets_FOUND)
      if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_VERSION)
        set(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_VERSION "v5.0.0")
      endif()
      ...
      if(NOT MINGW
        ...
        unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_LIBEVENT_LIBRARY)
        # Prefer the import library(.lib) over the DLL location. Passing a DLL to the linker is a fatal error on
        # MSVC(LNK1107 invalid or corrupt file).
        project_build_tools_get_imported_property(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_LIBEVENT_LIBRARY
                                                  libevent::core IMPORTED_IMPLIB)
        if(NOT ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_LIBEVENT_LIBRARY)
          project_build_tools_get_imported_location(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_LIBEVENT_LIBRARY
                                                    libevent::core)
        endif()
        if(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_LIBEVENT_LIBRARY)
          list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS
               "-DLWS_LIBEVENT_LIBRARIES=${ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_LIBEVENT_LIBRARY}")
        endif()
        unset(ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_LIBEVENT_LIBRARY)
      ...
      elseif(OPENSSL_FOUND AND NOT LIBRESSL_FOUND)
        ...
        if(WIN32
           OR CYGWIN
           OR MINGW)
          # libwebsockets v5.0 defaults to SChannel on Windows, keep using OpenSSL here
          list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS "-DLWS_WITH_SCHANNEL=OFF")
        endif()
        # libwebsockets v5.0 defaults HTTP/3(QUIC) to ON, and it forces GnuTLS when the SSL backend is OpenSSL. OpenSSL
        # does not support QUIC in libwebsockets, keep the HTTP/1 and HTTP/2 only behavior here.
        list(APPEND ATFRAMEWORK_CMAKE_TOOLSET_THIRD_PARTY_LIBWEBSOCKETS_BUILD_OPTIONS "-DLWS_WITH_HTTP3=OFF")
