...
if(MbedTLS_FOUND)
  ...
  list(GET MbedTLS_LIBRARIES 0 MbedTLS_LIBRARIES_LOCATION)
  set_target_properties(mbedtls PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "C;CXX" IMPORTED_LOCATION
                                                                                     "${MbedTLS_LIBRARIES_LOCATION}")
  list(LENGTH MbedTLS_LIBRARIES MbedTLS_LIBRARIES_LENGTH)
  if(MbedTLS_LIBRARIES_LENGTH GREATER 1)
    set(MbedTLS_LIBRARIES_LOCATION ${MbedTLS_LIBRARIES})
    list(REMOVE_AT MbedTLS_LIBRARIES_LOCATION 0)
    set_target_properties(mbedtls PROPERTIES INTERFACE_LINK_LIBRARIES "${MbedTLS_LIBRARIES_LOCATION}")
  endif()
  unset(MbedTLS_LIBRARIES_LOCATION)
  unset(MbedTLS_LIBRARIES_LENGTH)
endif()
