...
function(project_build_tools_generate_load_env_bash OUTPUT_FILE)
  ...
  if(ANDROID)
    file(
      ...
      "export ANDROID_NDK_SYSROOT=\"${ANDROID_SYSTEM_LIBRARY_PATH}\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
...
function(project_build_tool_generate_load_env_powershell OUTPUT_FILE)
  ...
  if(ANDROID)
    file(
      ...
      "$ENV:ANDROID_SYSROOT=\"${ANDROID_SYSTEM_LIBRARY_PATH}\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
      "$ENV:ANDROID_NDK_SYSROOT=\"${ANDROID_SYSTEM_LIBRARY_PATH}\"${PROJECT_THIRD_PARTY_BUILDTOOLS_BASH_EOL}"
