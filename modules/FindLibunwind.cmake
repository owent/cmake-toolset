...
if(PKG_CONFIG_FOUND)
  if(_LIBUNWIND_SEARCH_LIB AND EXISTS "${_LIBUNWIND_SEARCH_LIB}/pkgconfig")
    if("${_LIBUNWIND_SEARCH_LIB}/pkgconfig/libunwind.pc")
      pkg_check_modules(Libunwind GLOBAL "${_LIBUNWIND_SEARCH_LIB}/pkgconfig/libunwind.pc")
    elseif("${_LIBUNWIND_SEARCH_LIB}/pkgconfig/libunwind-generic.pc")
      pkg_check_modules(Libunwind GLOBAL "${_LIBUNWIND_SEARCH_LIB}/pkgconfig/libunwind-generic.pc")
    endif()
  else()
    pkg_check_modules(Libunwind GLOBAL libunwind)
    if(NOT Libunwind_FOUND AND NOT Libunwind_STATIC_FOUND)
      pkg_check_modules(Libunwind GLOBAL libunwind-generic)
    endif()
  endif()
